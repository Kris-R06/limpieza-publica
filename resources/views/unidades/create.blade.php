...
<div class="max-w-7xl mx-auto space-y-6 animate-fade-up">
    ...
    <div class="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
        ...
        <div class="px-8 py-6 border-b border-gray-100 bg-gray-50/50 flex items-center gap-4">
            ...
            <div>
                <h2 class="font-heading text-2xl font-bold text-slate-800 uppercase">Crear Nueva Unidad</h2>
            </div>
        </div>

        {{-- Cuerpo del Formulario --}}
        <form action="{{ route('unidades.store') }}" method="POST" class="p-8 space-y-6">
            @csrf
            <div class="space-y-2">
                ...
                <div class="relative group">
                    ...
                    <input type="text" 
                           name="nombre" 
                           id="nombre" 
                           placeholder="Ej. Unidad 1 o Unidad 2"
    ...
    <div class="bg-blue-50/50 border border-blue-100 rounded-xl p-4 flex items-start gap-3">
        ...
        <p class="text-xs text-blue-700 leading-relaxed">
            <strong>Dato de interés:</strong> Asegúrate de que el número de unidad no esté duplicado. El sistema de Mataranch organiza las unidades de forma alfanumérica para facilitar el monitoreo de los camiones.
        </p>
    </div>
