...
<div class="max-w-7xl mx-auto space-y-6 animate-fade-up">
    ...
    <div class="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
        ...
        <div class="px-8 py-6 border-b border-gray-100 bg-gray-50/50 flex items-center gap-4">
            ...
            <div>
                <h2 class="font-heading text-2xl font-bold text-slate-800 uppercase">Crear Nuevo Trabajador</h2>
            </div>
        </div>

        {{-- Cuerpo del Formulario --}}
        <form action="{{ route('trabajadores.store') }}" method="POST" class="p-8 space-y-6">
            @csrf
            <div class="space-y-2">
                ...
                <div class="relative group">
                    ...
                    <input type="text" 
                           name="nombre" 
                           id="nombre" 
                           placeholder="Ej. Juan Pérez o María López"
                ...
                <div class="relative group">
                    ...
                    <select name="tipo" 
                            ...
                            class="block w-full pl-11 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-slate-700 font-medium focus:ring-4 focus:ring-brand-500/10 focus:border-brand-500 transition-all outline-none"
                            required>
                        <option value="" disabled selected>Selecciona el tipo de trabajador</option>
